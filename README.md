...
3. Expected value of total flips until X heads in a row are seen

This is a way to verify the Law of Large numbers, as the amount of trials is increased, the closer the moving average becomes to the expected value of flips required.
